...
#prefab of to come functions to test
test_data:
	$(CC) $(DEBUGFLAGS) -o $(OBJDIR)/data.o -c $(SRCDIR)/data.c -I $(INCLUDEDIR) && $(CC) $(DEBUGFLAGS) test_data.c -o $(BINDIR)/test_data $(OBJDIR)/data.o -I $(INCLUDEDIR)
